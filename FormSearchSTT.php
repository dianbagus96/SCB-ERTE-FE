  ...
  <table width="620" border="0" cellspacing="1" cellpadding="3">
    <tr>
	  ...
	  <?php
		...
		$x1 = array("KD_STT","UR_STT");
		$kat = (in_array(strtoupper($kat),$x1))? $kat : $x1[0];
		
		$orderby = setSortir(array('sort'=>'KD_STT','order'=>'desc'),$x1);
		...
		$list[] = array("KD_STT","Kode Sandi");
		$list[] = array("UR_STT","Nama Sandi");
		$SQL = "Select KD_STT,UR_STT from tbldmSandiSTT";
