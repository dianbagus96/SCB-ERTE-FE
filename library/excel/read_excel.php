    ...
    */
    ...
    function read($sFileName) {
        ...
        if($res === false) {
        	...
        	// bad file
        		$button = '<button class="btn_1" onclick="document.location=\''.base_url.'modul/ssp/upload\'" type="button">Back</button>';					
        		die('<div id="content" style="margin-top:18px; width: 100%; background:#F0F0F0; border: 1px solid #D7D7D7;">
					<div style="font-family:arial; font-weight:lighter; font-size:11px; padding-top:10px; padding-bottom:10px; padding-left:10px;">
						<table cellpadding="0" cellspacing="0" style="font-family:arial; font-weight:lighter; font-size:11px;">
							<tr>
								<td><img src="'.base_url.'img/warning.png"/></td>
								<td style="padding-left:20px; font-family:arial; font-size:11px; color:#666; font-weight:bold;">
								The filename ' . str_replace("files/","",$sFileName) . ' is not readable &nbsp;'.$button.'</td>
							</tr>
						</table>
					</div>
				</div>');	
                ...
                case Spreadsheet_Excel_Reader_Type_XF:
                        ...
                        //echo "isnumber ".$this->numberFormats[$indexCode];
                            ...
                            if ($indexCode > 0){
                            	/*echo "banyak";
								echo $indexCode;
								print_r($this->formatRecords);
								echo $this->formatRecords[format];
								*/
								$formatstr="";
								if (isset($this->formatRecords[$indexCode])) $formatstr = $this->formatRecords[$indexCode];
                                //echo '.other.';
                                //echo "\ndate-time=$formatstr=\n";
                                if ($formatstr)
